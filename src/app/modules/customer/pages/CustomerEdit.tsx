...
export default function CustomerEdit() {
  ...
  useEffect(() => {
    ...
    setSource(customerData.source);
    setRemark(customerData.remark);
    // 初始化选中的楼盘
    const initialBuildings = buildingsData.filter(b => customerData.buildings.includes(b.name));
  ...
  const saveCustomer = () => {
    ...
    console.log('更新客户信息:', updatedData);
  ...
  return (
    <div className="h-screen flex flex-col bg-[#F7F8FA]">
      ...
      <header className="bg-white border-b border-[#E5E6EB] px-4 py-3 flex items-center justify-between sticky top-0 z-20">
        ...
        <span className="text-[17px] font-semibold text-[#1D2129]">编辑客户</span>
      ...
      <div className="px-4 py-4 bg-[#F7F8FA] flex items-start gap-2">
        ...
        <span className="text-[13px] text-[#86909C]">修改客户信息，用于关联录音分析</span>
      </div>
