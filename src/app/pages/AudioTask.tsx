  ...
  return (
    <div className="min-h-screen bg-[#F7F8FA]">
      ...
      <header className="bg-white border-b border-[#E5E6EB] px-4 py-3 flex items-center justify-between sticky top-0 z-10">
        ...
        <h1 className="text-[17px] font-semibold text-[#1D2129]">录音分析</h1>
        <div className="w-9" />
      </header>
      ...
      <div className="p-4">
        <div className="bg-white p-6 rounded-2xl shadow-sm text-center">
          <Mic className="w-12 h-12 text-[#00B42A] mx-auto mb-4" />
          <h2 className="text-[17px] font-semibold text-[#1D2129] mb-2">录音分析执行页</h2>
          <p className="text-[14px] text-[#86909C]">任务 ID: {id}</p>
          <p className="text-[13px] text-[#4E5969] mt-4">这里是录音分析任务的执行界面</p>
        </div>
      </div>
    </div>
  );
